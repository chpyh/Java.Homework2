...
//     OfficialPrintedProduct наследует от класса PrintedProduct, который в свою очередь являетс янаследником Product.
    ...
    public class OfficialPrintedProduct<T> extends PrintedProduct<T> {

    protected T vendorCode;
    protected String title;
    protected Integer year;

    public OfficialPrintedProduct(T vendorCode, String title, T type, T id, Integer year) {
        super(type, id);
